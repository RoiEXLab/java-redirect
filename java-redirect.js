...
const getReplaceAlgorithm = async version => {
  ...
  const moduleMap = versionInt >= 11 ? await computeModuleMap(versionInt) : null;
	switch (versionInt) {
		case 8:
    ...
    case 12:
      return url => {
        if (url.includes('javafx')) {
          return url.replace(/^https?\:\/\/docs\.oracle\.com\/(?:javafx\/2|(?:en\/java\/)?javase\/(?:[89]|10|11)\/javafx)\/api\/(?:((?:java|jdk)\.(?:\w|\.)+)\/)?([a-z/]+)\//g, (_, g1, g2) => `https://openjfx.io/javadoc/12/${g1 || moduleMap[g2.replace(/\//g, '.')]}/${g2}/`);
        }
    ...
    case 13:
      return url => {
        if (url.includes('javafx')) {
          return url.replace(/^https?\:\/\/docs\.oracle\.com\/(?:javafx\/2|(?:en\/java\/)?javase\/(?:[89]|1[012])\/javafx)\/api\/(?:((?:java|jdk)\.(?:\w|\.)+)\/)?([a-z/]+)\//g, (_, g1, g2) => `https://openjfx.io/javadoc/13/${g1 || moduleMap[g2.replace(/\//g, '.')]}/${g2}/`);
        }
    ...
    case 14:
      return url => {
        if (url.includes('javafx')) {
          return url.replace(/^https?\:\/\/docs\.oracle\.com\/(?:javafx\/2|(?:en\/java\/)?javase\/(?:[89]|1[0123])\/javafx)\/api\/(?:((?:java|jdk)\.(?:\w|\.)+)\/)?([a-z/]+)\//g, (_, g1, g2) => `https://openjfx.io/javadoc/14/${g1 || moduleMap[g2.replace(/\//g, '.')]}/${g2}/`);
        }
    ...
    case 15:
      return url => {
        if (url.includes('javafx')) {
          return url.replace(/^https?\:\/\/docs\.oracle\.com\/(?:javafx\/2|(?:en\/java\/)?javase\/(?:[89]|1[01234])\/javafx)\/api\/(?:((?:java|jdk)\.(?:\w|\.)+)\/)?([a-z/]+)\//g, (_, g1, g2) => `https://openjfx.io/javadoc/15/${g1 || moduleMap[g2.replace(/\//g, '.')]}/${g2}/`);
        }
    ...
    case 16:
      return url => {
        if (url.includes('javafx')) {
          return url.replace(/^https?\:\/\/docs\.oracle\.com\/(?:javafx\/2|(?:en\/java\/)?javase\/(?:[89]|1[012345])\/javafx)\/api\/(?:((?:java|jdk)\.(?:\w|\.)+)\/)?([a-z/]+)\//g, (_, g1, g2) => `https://openjfx.io/javadoc/16/${g1 || moduleMap[g2.replace(/\//g, '.')]}/${g2}/`);
        }
    ...
    case 17:
      return url => {
        if (url.includes('javafx')) {
          return url.replace(/^https?\:\/\/docs\.oracle\.com\/(?:javafx\/2|(?:en\/java\/)?javase\/(?:[89]|1[0123456])\/javafx)\/api\/(?:((?:java|jdk)\.(?:\w|\.)+)\/)?([a-z/]+)\//g, (_, g1, g2) => `https://openjfx.io/javadoc/17/${g1 || moduleMap[g2.replace(/\//g, '.')]}/${g2}/`);
        }
    ...
    case 18:
      return url => {
        if (url.includes('javafx')) {
          return url.replace(/^https?\:\/\/docs\.oracle\.com\/(?:javafx\/2|(?:en\/java\/)?javase\/(?:[89]|1[01234567])\/javafx)\/api\/(?:((?:java|jdk)\.(?:\w|\.)+)\/)?([a-z/]+)\//g, (_, g1, g2) => `https://openjfx.io/javadoc/18/${g1 || moduleMap[g2.replace(/\//g, '.')]}/${g2}/`);
        }
    ...
    case 19:
      return url => {
        if (url.includes('javafx')) {
          return url.replace(/^https?\:\/\/docs\.oracle\.com\/(?:javafx\/2|(?:en\/java\/)?javase\/(?:[89]|1[012345678])\/javafx)\/api\/(?:((?:java|jdk)\.(?:\w|\.)+)\/)?([a-z/]+)\//g, (_, g1, g2) => `https://openjfx.io/javadoc/19/${g1 || moduleMap[g2.replace(/\//g, '.')]}/${g2}/`);
        }
    ...
    case 20:
      return url => {
        if (url.includes('javafx')) {
          return url.replace(/^https?\:\/\/docs\.oracle\.com\/(?:javafx\/2|(?:en\/java\/)?javase\/(?:[89]|1\d)\/javafx)\/api\/(?:((?:java|jdk)\.(?:\w|\.)+)\/)?([a-z/]+)\//g, (_, g1, g2) => `https://openjfx.io/javadoc/20/${g1 || moduleMap[g2.replace(/\//g, '.')]}/${g2}/`);
        }
    ...
    case 21:
      return url => {
        if (url.includes('javafx')) {
          return url.replace(/^https?\:\/\/docs\.oracle\.com\/(?:javafx\/2|(?:en\/java\/)?javase\/(?:[89]|1\d|20)\/javafx)\/api\/(?:((?:java|jdk)\.(?:\w|\.)+)\/)?([a-z/]+)\//g, (_, g1, g2) => `https://openjfx.io/javadoc/21/${g1 || moduleMap[g2.replace(/\//g, '.')]}/${g2}/`);
        }
